...
int msm_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (0 == strcmp(sensor_name, "ov8856_chicony_front")
		&& 1 == id_match && 0 == ov8856_read_mask ) {
...
#ifdef CONFIG_MACH_ASUS_X00TD
	if (0 == strcmp(sensor_name, "gc5025_ofilm_13m") 
		&& gpio_get_value(SUB_CAM_ID_PIN)) {
		pr_err("Sub camera is 16+5M ofilm Configuration");
		return -ENODEV;
	}

	if (0 == strcmp(sensor_name, "hi556_holitech_13m") 
		&& gpio_get_value(SUB_CAM_ID_PIN)) {
