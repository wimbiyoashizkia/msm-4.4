...
clone() {
	...
	git clone https://github.com/neonproject-org/aarch64-gcc.git -b elf-11 --depth=1 gcc64
	git clone https://github.com/neonproject-org/arm-gcc.git -b elf-11 --depth=1 gcc32
